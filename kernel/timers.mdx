---
title: "PIT Timer and Tick-Based Delays in SilverOS"
sidebarTitle: "Timers"
...
The command byte `0x36` selects channel 0, lobyte/hibyte access mode, and mode 3 (square wave generator), which is the standard rate-generator mode used by PC-compatible operating systems.
