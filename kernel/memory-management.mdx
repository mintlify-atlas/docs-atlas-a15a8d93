...
description: "SilverOS manages physical pages with a flat bitmap allocator and provides kernel dynamic memory via a linked-list heap. Full API reference for pmm and heap."
---
