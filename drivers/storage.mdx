---
title: "ATA PIO Storage and Real-Time Clock Drivers"
...
|---|---|
| `ata_init` | Selects the master drive on the primary bus, waits for `ATA_SR_DRDY`, and logs the result. |
...
| Function | Description |
|---|---|
| `rtc_init` | Verifies the RTC is not in an update cycle and logs initialization to serial. |
